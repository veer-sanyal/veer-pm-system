...
| Trice Systems (Hyderabad hyperlocal-commerce startup; warm intro via Sudip Uncle) | — (no posting; resume sent 2026-06-15; Sudip Jul 3: "from next week u can start"; **availability CORRECTED 2026-07-25: 8:00–10:30am IST weekdays** (= 7:30–10:00pm PT the previous day, Veer's evening). Supersedes the Jul 5 reply, which offered 9:30–11pm IST — that is 9:00–10:30am PT and was never achievable against his ~11:00 wake anchor (`sleep-protocol.md`). Naveen replied Wed Jul 22: "travelling till Saturday, ping me Saturday and we can set up a time"; ping owed/sent Sat Jul 25 — **awaiting his times**. Ask on the call: role family / weekly hours / remote-vs-Hyderabad + externship disclosure; size at Jul 5 Sunday session vs externship Wk 1) | Submitted → **Converting** | `applications/Trice/` |
