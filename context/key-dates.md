...
| Trice Systems (Hyderabad hyperlocal-commerce startup; warm intro via Sudip Uncle) | — (no posting; resume sent 2026-06-15; **Sudip Jul 3: "from next week u can start", asked for IST-mapped availability — reply pending, tripwire**. Role family / hours / remote still unknown; size at Jul 5 Sunday session vs externship Wk 1) | Submitted → **Converting** | `applications/Trice/` |
