...
| TikTok — AI Agent Product Manager Intern (Product Infrastructure – Customer Service Platform), Summer 2027, San Jose, CA, Job Code A115604, $35/hr | Rolling, reviewed in order of submission; posting surfaced 2026-08-08 — apply within 2 weeks per timing strategy | **STAGED TO SUBMIT (2026-08-20 night)** — resume (final, Cairn + agent-build version) uploaded to lifeattiktok.com as VeerSanyal_TikTokAIAgent_Resume.pdf; every form field driven and verified in-browser (ATS parse garbling cleaned, work-auth Yes/No answered from Claude Corps precedent, source=Recruitment Website); ONLY Submit remains, Veer's click | `applications/TikTok - AI Agent PM Intern/` |
