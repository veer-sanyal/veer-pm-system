...
| Trice Systems (Hyderabad hyperlocal-commerce startup; warm intro via Sudip Uncle) | — (no posting; resume sent 2026-06-15; Sudip Jul 3: "from next week u can start"; **availability reply SENT Jul 5 9:59am PT (9:30–11pm IST weekdays) — awaiting team-call scheduling**. Ask on the call: role family / weekly hours / remote-vs-Hyderabad + externship disclosure; size at Jul 5 Sunday session vs externship Wk 1) | Submitted → **Converting** | `applications/Trice/` |
