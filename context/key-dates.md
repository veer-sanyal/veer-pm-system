...
| Mobility Global (S&P Global Mobility) — Product Management Intern (Early Careers), Southfield, MI | Rolling, no deadline stated; posting surfaced 2026-08-08 — apply within 2 weeks per timing strategy | **Submitting (2026-08-20)** — Workday account created, application driven through Voluntary Disclosures in-session (resume uploaded, experience/education/questions verified field-by-field); Veer finishing EEO + Self Identify + Review and pressing Submit himself. Confirm submitted at next reconcile. | `applications/Mobility Global/` |
| TikTok — AI Agent Product Manager Intern (Product Infrastructure – Customer Service Platform), Summer 2027, San Jose, CA, Job Code A115604, $35/hr | Rolling, reviewed in order of submission; posting surfaced 2026-08-08 — apply within 2 weeks per timing strategy | **Ready** (resume built 2026-08-08; NOT submitted — final application requires an account on lifeattiktok.com, which is Veer's step) | `applications/TikTok - AI Agent PM Intern/` |
