...
\vspace{4mm}
{\large\bfseries 1. Every session: the lifecycle}
...
\begin{tikzpicture}[node distance=6mm and 9mm]
  ...
  \node[main, text width=34mm, below=9mm of g1] (rec) {auto-run \texttt{/reconcile}\\first (see map 2)};
...
\newpage
{\large\bfseries 2. \texttt{/reconcile}: the one workflow that spawns subagents}
...
\newpage
{\large\bfseries 3. Command nesting and deferred protocol docs}
...
\vspace{6mm}
{\large\bfseries 4. What the usage record shows (telemetry Jul 3--15, git Jun 9--Jul 15)}
