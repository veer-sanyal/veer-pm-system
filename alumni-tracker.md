...
## Shortlist (today's task: fill all 10)

All 10 verified live on LinkedIn 2026-06-09 (titles from current profiles/headlines):

| # | Name | Company | Title | Grad year / program | Shared tie | LinkedIn | Msg date | Reply | Call | Notes |
|---|------|---------|-------|--------------------|------------|----------|----------|-------|------|-------|
...
| 4 | Daniel Anicito ("Danny") | Fidelity Investments | Associate PM (now started) | Purdue student (FMA VP Education) | 2nd degree; mutuals: Christopher, Ian +5 | linkedin.com/in/daniel-anicito · cell 516-404-2194 | 2026-06-20 (connect note) | **2026-06-25 (YES)** | **RAN 2026-07-08, went well** — second completed informational interview. Debrief in the relationships log (`ledgers.md`) | **Warm and now actively open: Jul 8 3:12pm he messaged first, gave his cell + offered coffee on campus, signed "Danny." Thank-you drafted same day — takes the coffee offer (fall), who-else ask folded in.** Interview pointers he gave (Pillar-4): it's fine to pause and reason ("give me a second to think"); an answer only needs to be justifiable, not perfect; cut yourself off if you're looping without substance; his "product you enjoy → laptop camera → I'm a face-to-face person" story is the model; **on nerves — if you landed the interview, be confident, they already think you're competent (the one Veer said stuck most).** Networking: take every weird warm intro (worst case 30 min); clubs are where the iron-sharpens-iron peers come from. **If he names contacts → warm-intro shortlist rows** |
| 5 | Steven LaCroix | Elanco | Associate Product Manager | Purdue (recent grad), Data Sci & Stats | 2nd degree → now 1st | linkedin.com/in/stevenjlacroix | 2026-06-25 (connect note) | **2026-06-26 (YES)** | **RAN 2026-07-07, went well** — first completed informational interview. Debrief in PROGRESS relationships log | **Warm, keep-updated agreed; thank-you SENT same day (Jul 7 ~2:55pm, referral ask folded in)**. Key advice: faculty-facing leadership > student-only for recruiters; APM rotationals are the realistic top-5 door. **Jul 10 reply: no names ("can't think of anyone"), keep-me-updated re-affirmed ("excited to hear how things work out") — loop CLOSED Jul 11; next touch event-based at a real milestone** |
...
| 9 | Meet Kansara | Amazon | Sr. Product Manager | Purdue (verify yr) | Purdue | linkedin.com/in/meet-kansara | | | | Amazon PM-T intern path question |
| 10 | Sylvia Lu | AWS | Sr. Product Manager, Technical | Purdue (verify yr) | Purdue | linkedin.com/in/xueting-sylvia-lu | | | | PM-T — technical-credibility angle |

**Bench** (next in line if a slot goes cold):

| Name | Company | Title | LinkedIn |
|------|---------|-------|----------|
| Amay Rane | Meta | AI/ML PM, Meta Ads | linkedin.com/in/amay-rane-8866812a |
| Arjun Subbarao | (verify) | Sr. PM / TPM | linkedin.com/in/arjunsubbarao |
| Arul Srinivas | Kredos AI | Senior PM (agentic AI, payments) | linkedin.com/in/arulsrinivas |
| Yuan Z. | (verify) | Product & Project Manager, AI & Automation | linkedin.com/in/yuanzhang0301 |
...
| Business client owner | **Bryon Haverstick, COO, Scouting America Sagamore Council** (sagamorebsa.org; cell 765-250-6139, given Jul 20 "call, text, whatever") | **first client meeting RAN Jul 20** (52 min, warm + candid); his annual-cycle doc due Tue Jul 21 | Real stakeholder for the comms/marketing-plan engagement; reference + product-story source. Full call log in `ledgers.md` relationships log; transcript in `projects/sagamore/bryon-call-transcript-2026-07-20.md`. |
| Externship teammates | **Prisha Goswami** (pgoswami@purdue.edu, Alumni Communicator), **Jiada Li** (li5375@purdue.edu, D&Q Lead pending confirm — declined kickoff), **Isabel Yura** (iyura@purdue.edu, Client Communicator) | **final-package meeting RAN Fri Aug 7** (Teams, Veer + Izzy + Prisha; Jiada dark all summer). Izzy returned her own annotated website markup (design/IA) — complements Veer's audit (conversion/accessibility), does not duplicate it. Prisha: reposts + holidays keep the page active, Bryon need not originate every post. **Plan: all parts by Tue Aug 11; Izzy to book a closing call with Bryon Wed Aug 12 or Thu Aug 13.** | Peer network. Izzy holds Main Client Communicator and is the correct sender. Open: a confirmed date on Prisha's Canva templates. Detail in `ledgers.md`. |
...
- 3-8 years out: senior enough to refer, junior enough to reply
- PM or PM-adjacent title at the probable Purdue clusters: Amazon, Microsoft, Google, Walmart Global Tech, Capital One, JPMorgan, Salesforce, High Alpha / Indy tech
- MEM alumni are disproportionately PM-dense (MEM incubated the PM Club) — mine that sub-network
- Mix it: aim for at most 2-3 per company so one cold pocket doesn't sink the week

**Steps:**

1. Open `linkedin.com/school/purdue-university/people` (Alumni Tool)
2. "What they do" → Product Management. Intersect with "Where they work" → Google / Amazon / Microsoft etc.
3. Keyword box for what filters miss: `Product Manager`, `APM`, `Technical Program Manager`, `Product Analyst`
4. Repeat on the Purdue MEM page (`linkedin.com/company/purduemem`) and Daniels/Krannert sub-page

**Boolean queries** (paste into People search, add School = Purdue filter; operators must be UPPERCASE):

```
("Product Manager" OR "Associate Product Manager" OR APM) AND (Google OR Amazon OR Microsoft)
("Product Analyst" OR "Strategy and Operations" OR "Strategy & Ops")
("Technical Program Manager" OR "Program Manager") NOT recruiter
("Product" OR "Strategic Analyst") AND ("Capital One" OR JPMorgan OR "JP Morgan")
```

---

## Message blueprint (when sending starts)

4-6 sentences, Stanford 5-part structure (full version in the networking doc):

1. Who you are (Purdue IBE '28, prior SWE internship)
2. How you found them (Purdue Alumni Tool / shared program)
3. Why them specifically (their PM path at their company, a product they own)
4. The ask: 20 minutes, specific question, not a referral
5. Easy out + thanks

Concrete hook you have that most sophomores don't: the live MSME digital-trade exposure dashboard. Link it when relevant.
...
- Calls booked: 2 (Steven LaCroix — Tue Jul 7, 5:00–5:15pm ET / 2:00pm PT; invite **ACCEPTED 2026-06-29** — confirmed, Meet link. Daniel Anicito — Wed Jul 8 5:30pm ET / 2:30pm PT; invite sent Jul 7, Meet link).
- Calls completed: **2** (Steven LaCroix, 2026-07-07 — went well, keep-updated agreed; Daniel Anicito, 2026-07-08 — went well, keep-updated agreed, interview/networking pointers)
- Referrals: 0

Reply rate so far: 2 sent → 2 replied → 2 booked → **2 completed**. Small n, but the alumni-tie angle is converting end to end; two warm keep-updated relationships now established.
