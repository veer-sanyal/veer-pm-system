...
| Business client owner | **Bryon Haverstick, COO, Scouting America Sagamore Council** (sagamorebsa.org; cell 765-250-6139, given Jul 20 "call, text, whatever") | **ENGAGEMENT CLOSED on the final call Aug 17** — grateful, said the work will be used and will have "a lasting impact"; one item owed: the consolidated deliverables ZIP (`sagamore-final-zip`) | **Confirmed reference + the first-client product story.** Full log in `ledgers.md` relationships log; transcript in `projects/sagamore/bryon-call-transcript-2026-07-20.md`. Future touches event-based (e.g. when a recommendation visibly ships on his pages). |
| Externship teammates | **Prisha Goswami** (pgoswami@purdue.edu, Alumni Communicator), **Jiada Li** (li5375@purdue.edu, D&Q Lead pending confirm — declined kickoff), **Isabel Yura** (iyura@purdue.edu, Client Communicator) | **externship CLOSED with the Aug 17 final call** (all three + Bryon; Jiada dark all summer). Warm close message to the group chat staged in `networking/sends-2026-08-17.md`. | Peer network, now alumni-of-the-project: three warm Purdue relationships, event-based touches from here. Detail in `ledgers.md`. |
