...
6. **`purdue-fall-registration` — OPENED 2026-08-21, hard deadline Thu Aug 28.** Alec's reply settled the shape (full answers: PROGRESS 2026-08-21): STRT 49200 -> senior year, MIS 38800 -> IBE cohort this spring, EPCS covers STS, Specialty Area = **Data Analytics**, **drop EPCS 20100 and add VIP 37920**. New requirement surfaced: **IBE 29150 must be repeated Fall 2027.** Optional lever: STRT 352IBE this fall. Actions in order: (a) clear the **Purdue account hold** (outstanding since Aug 20, blocks registration changes); (b) **send the staged Zakharov email** (`networking/sends-2026-08-21.md`) to confirm the AIE CRN and resolve the conflict below; (c) **Alec appointment Mon Aug 24 — BoilerConnect says 2:30-3:00pm ET, Veer's own email says 11:30; confirm which.**
7. **`vip-aie-seat` — OPENED 2026-08-21, replaces the mis-scoped `vip-aie-qm-conflict` (that conflict does not exist; QM 30500 was never moved to TR 3:00).** **AIE is CONFIRMED and already in the cart: VIP 37920 Lab CRN 11958-022, R 3:30-4:20p, WALC 3084, note reads "AI for Education".** The cart is conflict-free at 14 credits with EPCS 20100 staged for drop, exactly as Alec directed. **The whole thing is UNSUBMITTED and the lab shows `1 / 18` seats available** (QM 30600 shows 3/64). **Next physical action: press Submit Schedule.** Every attempt to improve the times failed and the reason is structural: SCOM 36100IBE is forced to TR 4:30 because its only alternative collides with the VIP lab, which in turn leaves QM 30500 no non-conflicting section but MWF 8:30, and SYS 35000 offers no alternatives at all. **The 8:30am is the price of the lab. Do not spend seat-risk minutes trying to fix it.** Sections can be swapped until the Aug 28 add deadline if anything frees up. Detail: PROGRESS 2026-08-21.
