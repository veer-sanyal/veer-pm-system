...
7. **`vip-aie-qm-conflict` — OPENED 2026-08-21, the actual blocker.** **AIE's section is CRN 11958, lab Thursday 3:30, WALC 3084** (recovered from the public purdue.io API by instructor cross-reference; NOT officially labeled AIE anywhere public, so confirm before trusting it). **It overlaps QM 30500 sec 016, TR 3:00-4:15, and VIP will not approve a registration that conflicts with the team meeting time.** The Aug-20 plan's two moves are mutually exclusive as written; QM is the piece that moves. Do not hunt sections by instructor: Zoltowski and Lynch are the VIP program directors and sit on most sections, while team faculty often do not appear at all. If AIE falls through, the next VIP fits are **LabTA_AI** and **EdTechDev** (both ed-tech AI, STICK-adjacent), then OptiChat and NanoHUB. **EPICS is the weaker path** and its West Lafayette roster has nothing STICK-adjacent; Alec's ruling and the scan agree. Detail: PROGRESS 2026-08-21.
