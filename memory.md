...
- **Start Pillar 3 outreach: 3 alumni messages/week**, now the first LinkedIn post is live (the gate that was holding it). **Status: week of Jun 15 finished at 1 of 3 — Daniel Anicito (Fidelity Investments APM), LinkedIn connect note, Jun 20. Anicito REPLIED yes 2026-06-25 — the first alumni reply; converts to a call, being scheduled for next week after 5pm ET (proposed Tue Jun 30 5:30pm ET). First informational interview is now within reach.** Week of Jun 22 target is 3, **front-loaded Mon–Wed**: LaCroix (Mon, drafted/ready), Akash Ravi (Tue, after a Mon comment on his post), Allan Tan (Wed, draft in Tue secondary). Front-loading is the fix for last week, when all 3 slipped to the end and only 1 sent. Note: LinkedIn free connect-notes cap at 200 chars and ~3-5 personalized invites/month — a real volume constraint to plan around (connect-without-note / comment-then-message, or time a free Premium trial to the fall crunch).
