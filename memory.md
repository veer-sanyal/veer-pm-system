...
- **Dr. G call is TODAY (Thu Jun 18), RESCHEDULED to 3:45–4:15pm PT (Google Meet).** Reply sent, slot locked (his scheduler moved it from 1:00pm the evening of Jun 17). Prep sheet ready (`dr-g-call-prep-2026-06-18.md`): lead with the EBOPS→NIC crosswalk-as-screening-heuristic question (unanswered in writing), the composite-index components still deferred (digital-adoption, policy-sensitivity), and what client routing he had offered. Send a specific thank-you within 24h after.
