...
- **Sleep-fix workstream LIVE (2026-06-25) — upstream of all four pillars.** The calendar spine was anchored to a fixed 9am wake Veer kept missing (waking 11am-1pm, screen-driven, behavioral not insomnia); fixing it unblocks the outreach + study that kept slipping because the day started at noon. Protocol owner: `context/sleep-protocol.md` (evidence base: `files/sleep-circadian-research-2026-06-25.md`). Config chosen: stepped wake advance (~45 min earlier every ~3 days, hold-until-sticks), morning bright light + 0.5mg afternoon melatonin, phone across the room, track 3 indicators (wake time / minutes-to-sleep / phone-down). **Current step: 1 (wake 11:15, first full day Fri Jun 26).** Hard 9:00 lock targeted ~Jul 5, held through August so it is locked before classes ~Aug 24. Each morning Veer sends "initialize"; daily indicators logged in PROGRESS "System signals."
...
- **Sleep schedule (highest-leverage, active):** run the `context/sleep-protocol.md` ladder. Step 1 wake 11:15 starts Fri Jun 26; advance a step only when it sticks; hard 9:00 lock ~Jul 5, held through August. Daily "initialize" each morning. Upstream of Pillars 2 and 3 (study + outreach kept slipping because the day started at noon).
