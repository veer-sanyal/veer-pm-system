...
- **AMEX SUBMITTED 2026-08-21.** GCS PM Intern Summer 2027 (26011916, NYC). Third Summer-2027 submission of the cycle, and the first against a hard deadline (Sep 30) rather than a rolling one. **IBM req 128509 is staged at 60% and still needs Veer:** date of birth, the EEO self-IDs, the "I certify" attestation, then submit. Everything else is filled. Docs and full state: `applications/IBM/`, `applications/American Express/`, timing in `context/key-dates.md`.
