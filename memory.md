...
- **TWO APPLICATIONS ARE STAGED AT READY and both are Veer-presses-submit** (built Aug 21, reviewer-audited, one page, `resume-check` clean; docs in `applications/IBM/` and `applications/American Express/`): **IBM PM Intern 2027** (req 128509, rolling) and **Amex GCS PM Intern Summer 2027** (26011916, **hard deadline 2026-09-30 21:00, the only dated one in the pipeline**; grad-window eligibility confirmed in the req text, no CS line). Timing and stage live in `context/key-dates.md`.
