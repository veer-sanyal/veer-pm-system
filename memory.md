...
4. **Sudip Uncle's Trice reply UNANSWERED since Fri Jul 3 8:41pm**: "from next week u can start" + wants Veer's time windows mapped to IST. Smallest action: send the drafted WhatsApp reply (IST-evening windows, ask for the team call). Commit hours only AFTER the Sunday session sizes Trice against externship Week 1; the call itself is information-gathering (role family / weekly hours / remote-vs-Hyderabad).
