...
- **Steven LaCroix (Associate PM, Elanco — Purdue recent grad, Data Sci & Stats; data-to-PM path via the Data Mine).** 2026-06-25: connection note sent via Chrome (data-to-PM hook, "rising junior" framing). **2026-06-26: replied YES** (accepted + messaged; caught by the step-3c Gmail scan). Second reply of the funnel. His message: warm, but flagged there was *"no real strategy... right place, right time,"* and offered to chat the **week of Jul 6** (on vacation the Jun 29 week). 2026-06-27: drafted Veer's reply — honor the honesty, reframe the ask to the *situation/positioning*, proposed **Tue Jul 7 / Wed Jul 8 ~5pm ET** + offer of a calendar invite. Prep at `networking/LaCroix-Elanco-call-prep.md`. Next: confirm the slot, send the invite, run the call off the sheet. Watch the Daniels Externship Week-1 overlap.
