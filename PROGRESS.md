...
- **2026-06-20: thank-you DRAFTED** (in-thread, pending Veer's send) — references the India share + the US-version idea, offers to take on a first US version, confirms follow-up. **US prior-art check DONE** (no US equivalent of the SME-sector exposure screen exists; data building blocks do, and US sector data is richer so the crosswalk caveat shrinks).
