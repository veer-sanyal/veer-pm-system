...
## 1. Spectroplast (Zurich) — silicone 3D printing, first choice for P1-P4
To: via https://spectroplast.com contact/quote form (or sales@spectroplast.com)
Subject: RFQ: 4 prototype parts in TrueSil A20, medical proof-of-concept
...
- Material: your TrueSil A20 (Shore A 20). Two questions: (a) can you formulate or recommend anything softer, in the Shore A 15-20 range, for one variant? (b) which TrueSil grades carry biocompatibility data (ISO 10993 / skin contact)?
- Surface: smooth, seam-free patient-contact surfaces; no support residue in the internal lumen (4-6 mm channel)
- Files: we will supply STEP files. Do you offer design-for-AM review before printing?
...
## 2. Ami Polymer Pvt Ltd (Mumbai) — ISO 13485 India path
To: via https://www.amipolymer.com contact (info@amipolymer.com listed on site)
Subject: RFQ: custom platinum-cured silicone molded part, prototype quantity (2-4 pcs)
...
- Small part: approx. 50-60 mm long, 45-55 mm flange diameter, 4-6 mm internal lumen; smooth patient-contact surfaces, no flash or seam on the contact face
- Prototype quantity first: 2-4 pieces (we can supply a 3D-printed mould or master, or work from our STEP files with your tooling — please advise which you prefer)
- Please confirm: do you mold custom parts at this hardness in platinum-cured medical grade (we saw it cited on your diaphragm line), and what material certificates (ISO 10993 / USP Class VI) would accompany it?
...
## 3. iMake (Hyderabad) — backup India option
To: via https://www.imake.in contact form
Subject: RFQ: custom silicone part from CAD, 2-4 prototype pieces
...
2. Is your medical/food-grade silicone supported by biocompatibility or FDA/ISO 10993 material documentation?
3. Indicative cost and lead time for tooling + 4 pieces from a supplied STEP file?
...
## 4. CDSCO regulatory consultant — classification opinion
To: a Delhi/Mumbai regulatory consultancy (e.g. Operon Strategist, Morulaa, or equivalent — pick one with medical device MD-5/MD-13 track record)
Subject: Classification opinion + test-license roadmap for a novel Class A/B device
...
3. Down the line: MD-3 → MD-5 state manufacturing licence roadmap and whether you handle Karnataka SLA filings.
...
## 5. IP counsel — FTO + filing strategy
To: an Indian patent attorney with US practice ties
Subject: FTO check + filing strategy for a medical device (one known US patent)
...
3. Our own filing: given this prior art (US + WO publication), what, if anything, of our design is still patentable in India (or as a design registration), and is it worth filing before we brief manufacturers beyond NDA?
...
## Sending order
1. IP counsel (item 5) FIRST or in parallel — cheap check, and its answer shapes how freely the spec circulates.
