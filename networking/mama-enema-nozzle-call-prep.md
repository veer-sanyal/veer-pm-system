...
- This is both direct prior art (limits what HE can patent) and a potential infringement problem for US sales until Aug 2032. India: only a US patent — no evidence of an Indian family member, so making/selling in India is likely unaffected (verify).
