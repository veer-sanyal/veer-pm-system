...
- direction.md owns the strategy: goal, four pillars, targets, decision rules.
...
- Google Calendar (Veer's primary, Pacific time) holds the live operational schedule AND is the delivery channel for the daily plan. The recurring blocks and the 9:00 Morning Briefing events are where the plan actually reaches Veer. See daily-email-instructions.md.
...
3. about-me.md - who Veer is, his rhythm, what works on him
4. direction.md - goal, four pillars, targets, decision rules
5. key-dates.md - the recruiting timeline
...
6. scheduling-blueprint.md - the behavioral science governing the plan
7. daily-email-instructions.md - how the daily calendar briefing and the Sunday session are composed and written to the calendar
8. The full past week of PROGRESS.md - to ground the week in real progress (and DECISIONS.md from the product repo if product decisions are in play)
...
- Outreach / alumni / referrals / informational interviews -> Genuine_Networking_for_Competitive_PM_Internships.md (+ research-purdue-network-recruiting.md)
...
Cite specific findings (named studies and stats), not just "the research says." The docs/ copy is the working summary; the files/ copy is the full original for deep dives.
